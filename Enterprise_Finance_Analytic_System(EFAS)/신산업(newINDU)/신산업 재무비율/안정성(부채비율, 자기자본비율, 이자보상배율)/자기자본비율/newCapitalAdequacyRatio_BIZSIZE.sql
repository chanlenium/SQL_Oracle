...
DROP TABLE IF EXISTS Result_newINDU_CapitalAdequacyRatio_BIZSIZE;
SELECT DISTINCT
	t00.STD_YM,
	...
	INTO Result_newINDU_CapitalAdequacyRatio_BIZSIZE
FROM
	(	
	SELECT 
		t0.*,
...
ORDER BY t00.STD_YM;
-- 결과 조회
SELECT * FROM Result_newINDU_CapitalAdequacyRatio_BIZSIZE ORDER BY STD_YM;
