...
-- (Step1) 테이블 생성(EFAS, 당해년도 전체기업수, 당해년도 기준 1개년 연속 적자기업수, 당해년도 기준 2개년 연속 적자기업수, 당해년도 기준 3개년 연속 적자기업수, 
-- 전년도 전체기업수, 전년도 기준 1개년 연속 적자기업수, 전년도 기준 2개년 연속 적자기업수, 전년도 기준 3개년 연속 적자기업수)	
SELECT DISTINCT
	t00000.EFAS,
	t00000.thisYM,
	CASE	-- 당해년도 전체 기업수
...
-- (Step2) 당해년/전년 동월 한계기업 비중 및 전년 동월 대비 증가율 계산
DROP TABLE IF EXISTS RESULT_MARGINAL_RATIO_EFAS;
SELECT 
  	t.EFAS, 
  	t.thisYM,
  	-- 최직근년도 영업적자 기준 한계기업
  	ROUND(t.this_CNT_N1_LOSS / NULLIF(t.this_CNTTOTCORP, 0), 4) as N1_this_MARGINALRATIO, -- 당해년도 
  	ROUND(t.prev_CNT_N1_LOSS / NULLIF(t.prev_CNTTOTCORP, 0), 4) as N1_prev_MARGINALRATIO, -- 전년동기
  	-- 2년연속 영업적자 기준 한계기업
  	ROUND(t.this_CNT_N2_LOSS / NULLIF(t.this_CNTTOTCORP, 0), 4) as N2_this_MARGINALRATIO,	-- 당해년도 
  	ROUND(t.prev_CNT_N2_LOSS / NULLIF(t.prev_CNTTOTCORP, 0), 4) as N2_prev_MARGINALRATIO, 	-- 전년동기
  	-- 3년연속 영업적자 기준 한계기업
  	ROUND(t.this_CNT_N3_LOSS / NULLIF(t.this_CNTTOTCORP, 0), 4) as N3_this_MARGINALRATIO, -- 당해년도 
  	ROUND(t.prev_CNT_N3_LOSS / NULLIF(t.prev_CNTTOTCORP, 0), 4) as N3_prev_MARGINALRATIO -- 전년동기
