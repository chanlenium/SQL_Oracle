...
SELECT 
  	...
  	SUM(DECODE(t0.STD_YM, CONCAT('${inputYYYY}' - 1, '12'), EFAS_INT_EXP, 0)) as prevYY_EFAS_INT_EXP, 
  	SUM(DECODE(t0.STD_YM, CONCAT('${inputYYYY}' - 1, '12'), EFAS_OP_PROFIT, 0)) as prevYY_EFAS_OP_PROFIT 
